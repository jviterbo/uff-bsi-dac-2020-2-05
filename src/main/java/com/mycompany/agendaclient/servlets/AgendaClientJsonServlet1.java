 ...
 * @author viter
 */
@WebServlet(name = "AgendaClientJsonServlet1", urlPatterns = {"/AgendaClientJsonServlet1"})
public class AgendaClientJsonServlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AgendaClientJsonServlet1.class.getName()).log(Level.SEVERE, null, ex);
        }
